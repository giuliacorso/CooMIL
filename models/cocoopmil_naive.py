...
class CoCoopMilNaive(ContinualModelCoCoopMil):
    NAME = 'cocoopmil_naive'
    COMPATIBILITY = ['class-il', 'domain-il', 'task-il', 'general-continual']

    def __init__(self, backbone, loss, args, transform):
        super(CoCoopMilNaive, self).__init__(backbone, loss, args, transform)
    ...
    def compute_loss(self, outputs, labels):
        ...
        #task_label = labels-(self.current_task)*2
